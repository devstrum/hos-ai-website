import { THEME, gridBg, CornerTicks, SiteNav, SiteFooter, CONTACT_EMAIL, IntegrationsBanner, TrustedByBar, PartnersStrip } from './theme.jsx';
    ...
    <div style={{ background: bg, color: ink, fontFamily: '"Geist Mono", monospace', minHeight: '100%' }} data-screen-label="Home">
      ...
      <section style={{ position: 'relative', padding: '72px 48px 56px', backgroundImage: gridBg }}>
        ...
        <div style={{ maxWidth: 900 }}>
          ...
          <h1 style={{ fontFamily: '"Geist", sans-serif', fontWeight: 600, fontSize: 104, lineHeight: .94, letterSpacing: '-0.05em', margin: 0 }}>
          ...
          <div style={{ marginTop: 56, display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 24, maxWidth: 620 }}>
            {[['3.2×', 'avg ROI within 6 months'], ['$1.4M+', 'labor cost eliminated'], ['12+', 'systems shipped']].map(([n, l]) => (
              <div key={l}>
                <div style={{ fontFamily: '"Geist", sans-serif', fontSize: 28, fontWeight: 600, letterSpacing: '-0.03em', color: ink }}>{n}</div>
      ...
      {/* ─── SOCIAL PROOF ─── */}
      <div style={{ padding: '18px 48px', borderBottom: `1px solid ${rule}`, display: 'flex', alignItems: 'center', gap: 12, fontSize: 12, color: muted, fontFamily: '"Geist Mono", monospace' }}>
      ...
      {/* ─── WORK INDEX TEASER ─── */}
      <section id="work" style={{ padding: '0 48px', borderTop: `1px solid ${ink}`, borderBottom: `1px solid ${ink}` }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', padding: '32px 0 8px' }}>
          <h2 style={{ fontFamily: '"Geist", sans-serif', fontSize: 40, fontWeight: 600, letterSpacing: '-0.03em', margin: 0 }}>Selected work</h2>
      ...
      <section style={{ padding: '96px 48px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 48 }}>
          <div>
            ...
            <h2 style={{ fontFamily: '"Geist", sans-serif', fontSize: 56, fontWeight: 600, letterSpacing: '-0.04em', margin: 0 }}>What we deliver.</h2>
          </div>
      ...
      <section style={{ padding: '96px 48px', borderTop: `1px solid ${ink}` }}>
        ...
        <h2 style={{ fontFamily: '"Geist", sans-serif', fontSize: 56, fontWeight: 600, letterSpacing: '-0.04em', margin: '0 0 56px', maxWidth: 760 }}>Senior team. Warm doors in Dubai. Model agnostic.</h2>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 1, background: rule, border: `1px solid ${rule}` }}>
          {[
